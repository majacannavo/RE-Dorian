...
# get tweets for tornado in vaccine, searched on May 4, 2021
...
vaccine_raw = rehydratoR(twitter_token$app$key, twitter_token$app$secret,
                twitter_token$credentials$oauth_token,
                twitter_token$credentials$oauth_secret, vaccineids,
...
may_raw = rehydratoR(twitter_token$app$key, twitter_token$app$secret,
                        twitter_token$credentials$oauth_token,
...
vaccine = lat_lng(dorian_raw, coords=c("coords_coords"))
...
write.table(may$status_id,
            here("data","derived","public","mayids_filtered.txt"),
            append=FALSE, quote=FALSE, row.names = FALSE, col.names = FALSE)

write.table(vaccine$status_id,
            here("data","derived","public","vaccineids_filtered.txt"),
            append=FALSE, quote=FALSE, row.names = FALSE, col.names = FALSE)
